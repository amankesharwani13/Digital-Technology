      ...
      <div className="order-invoice my-5">
        ...
        <div id="order_invoice" className="p-3 border border-secondary">
          <header className="clearfix">
            <div id="logo">
            <img src="/images/logo-photo-Photoroom.png-Photoroom.png" alt="ShopIT Logo" height="65px"  />
            </div>
            <h1>INVOICE # {order?._id}</h1>
            <div id="company" className="clearfix">
              <div>Digital Technology Data Centre</div>
              <div>
                455 Foggy Heights,
                <br />
                AZ 85004, US
              ...
              <div>
                <a href="mailto:info@shopit.com">info@digitaltechnologydatacentre.com</a>
              </div>
            </div>
            <div id="project">
              <div>
